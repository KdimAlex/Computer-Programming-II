...
public class TestSorter<E extends Comparable<E>> {
  ...
  public void test (Sorter<E> sorter, E[] array) {
    ...
    System.out.println("O() is " + time/sorter.O(array.length));
  ...
  public boolean sameElements (E[] array1, E[] array2) {
    ...
    Map<E,Integer> myFirstHashMap = new HashMap<E, Integer>();
    Map<E,Integer> mySecondHashMap = new HashMap<E, Integer>();
    ...
    for (int i = 0; i < array1.length; i++){
      if (myFirstHashMap.containsKey(array1[i])){
        myFirstHashMap.put(array1[i], myFirstHashMap.get(array1[i]) + 1);
      } else {
        myFirstHashMap.put(array1[i], 1);
      }
    }
    ...
    for (int i = 0; i < array2.length; i++){
      if (mySecondHashMap.containsKey(array2[i])){
        mySecondHashMap.put(array2[i], mySecondHashMap.get(array2[i]) + 1);
      } else {
        mySecondHashMap.put(array2[i], 1);
      }
    }
    ...
    for (int i = 0; i < array2.length; i++){
      if(!mySecondHashMap.get(array2[i]).equals(myFirstHashMap.get(array2[i]))){
        return false;
      }
    }
