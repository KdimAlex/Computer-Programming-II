    ...
    while (true) {
      ...
      for(String key1 : map.keySet()) {
        ...
        for (int index = 0; index < sortedLetters.length(); index++) {
          if (key1index < key1.length()  && key1.charAt(key1index) == (sortedLetters.charAt(index))) {
            key1index++;
          } else {
            key2 = key2 + sortedLetters.charAt(key1index);
          }
//          if (key1index == key1.length()) {
//            key2 = key2 + sortedLetters.charAt(key1index);
//          } else if (key1index < key1.length()  && key1.charAt(key1index) == (sortedLetters.charAt(index))) {
//            key1index++;
//          } else if (key1index < key1.length() && sortedLetters.charAt(index) > key1.charAt(key1index)) {
//            break;
//          } else {
//            key2 = key2 + sortedLetters.charAt(key1index);
//          }
